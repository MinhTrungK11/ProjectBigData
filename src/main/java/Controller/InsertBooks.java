 ...
 * @author Trung
 */
@WebServlet(name = "InsertBooks", urlPatterns = {"/add"})
public class InsertBooks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String bauthor = request.getParameter("thor");
        ...
        dao.InsertBooks(bid, bauthor, bbookformat, bdescription, bgenre, bimg, bisbn, blink, bpages, brating, breviews, btitle, btotalratings);
