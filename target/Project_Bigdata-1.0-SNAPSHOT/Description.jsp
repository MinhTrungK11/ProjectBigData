...
<head>
    ...
    <meta name="description" content="979-8-3507-0256-9, Sharon Babb Forrest, Dreams & Conversations">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0,  user-scalable=0" />
    <meta name="Author" content="ISBN AGENCY" />
    <link href="css2/bootstrap.css" tppabs="https://bookdatabase.online/css/bootstrap.css" rel="stylesheet">
    <link href="css2/style-2.css" tppabs="https://bookdatabase.online/css/style.css" rel="stylesheet">
    <link type="text/css" rel="stylesheet" media="screen" href="css2/footer_home.css" tppabs="https://www.isbn-us.com/wp-content/themes/isnbus/footer_home.css" />
    <link href="css2/responsive-1.css" tppabs="https://bookdatabase.online/css/responsive.css" rel="stylesheet">
    <link href="css2/font-awesome.min.css" tppabs="https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="css2/owl.carousel.min.css" tppabs="https://bookdatabase.online/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="css2/owl.carousel.css" tppabs="https://bookdatabase.online/css/owl.carousel.css">
    <link rel="stylesheet" type="text/css" href="css2/owl.theme.green.min.css" tppabs="https://bookdatabase.online/css/owl.theme.green.min.css">
</head>
...
<div class="section-content-loader">
  <div class="container">
	...
	<div class="col-sm-4 imgexists">
            <div class="book-img">
                <img class="img-responsive" src="${book.img}" tppabs="https://www.isbn-us.com/wp-content/uploads/cover/9798350704242.jpg" alt="">
            </div>
        </div>
        <div class="col-sm-8">
	    <div class="books-cont">
		<h1>${book.title}</h1>	
                <div class="isbnlabel">ISBN: ${book.isbn}</div>
		<div class="author_by">By: ${book.author}</div>	  			  
            </div>
        </div>
    </div>
  </div>
...
<div class="about-page">
  <div class="container">
       <div class="row">
		  <div class="col-md-8 about-description-head">
			<div class="about-description">
			  <div class="section-header">
				<h2 class="section-title"><span>ABOUT <span class="text-diff">THE BOOK</span></span></h2>
			  </div>
